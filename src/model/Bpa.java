...
public class Bpa {
  ...
  static String ano = Competencia.getAno();
  static String mes = Competencia.getMes();
  static String ups = Unidade.getCnes();
  static String sql_sem_idade = "select usp.cod_cnes AS CNES,c.ano_ref AS ANO, lpad(cast(c.mes_ref as varchar), 2, '0') AS MES, "
  ...
  static String sql_com_idade = "select usp.cod_cnes as CNES, c.ano_ref as ANO, lpad(cast(c.mes_ref as varchar), 2, '0') as MES, cbo.cod_cbo_ocupacao as CBO, "
  ...
  static String sql_individual = "select usp.cod_cnes as CNES,c.ano_ref||lpad(cast(c.mes_ref as varchar), 2, '0') as ano_mes, prof.cod_cns as CNS_PROF, cbo.cod_cbo_ocupacao as CBO,"
  ...
  public static ResultSet gerarBPASemIdade() throws SQLException {
    conexao = Conexao.getConexao();
    stmt = conexao.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
    ResultSet dados = stmt.executeQuery(sql_sem_idade);
    return dados;
  }

  public static ResultSet gerarBPAComIdade() throws SQLException {
    conexao = Conexao.getConexao();
    stmt = conexao.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
    ResultSet dados = stmt.executeQuery(sql_com_idade);
    return dados;
  }

  public static ResultSet gerarBPAIndividualizado() throws SQLException {
    conexao = Conexao.getConexao();
    stmt = conexao.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
    ResultSet dados = stmt.executeQuery(sql_individual);
    return dados;
  }

  public static String GeraCampoControle() throws SQLException {
